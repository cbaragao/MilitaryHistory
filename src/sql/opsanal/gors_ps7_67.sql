...
FROM opsanal.main.gors_ps7_67_nara ps7
LEFT JOIN opsanal.main.gors_67_gsvcs gs1
	ON remove_nan_decimals(ps7.LNAT)  = gs1.code
LEFT JOIN opsanal.main.gors_67_gtyps gt 
	ON remove_nan_decimals(ps7.LTYPE) = gt.code
LEFT JOIN opsanal.main.gors_67_gsvcs gs2
