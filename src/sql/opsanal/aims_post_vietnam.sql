-- AIMS Post-Vietnam (1976-1989): Cold War Peacetime Period
...
-- Time period: 1976-1989 (Post-Vietnam rebuild, Cold War tensions, peacetime operations)
...
SELECT
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(SECBD_MTG), -4) BETWEEN '1976' AND '1989'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(MERIT_START), -4) BETWEEN '1976' AND '1989'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(MERIT_END), -4) BETWEEN '1976' AND '1989'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(ORIG_RECMD_DATE), -4) BETWEEN '1976' AND '1989'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(ENDRSMT_DATE), -4) BETWEEN '1976' AND '1989'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(APPR_AWD_DATE), -4) BETWEEN '1976' AND '1989'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(MAIL_DATE), -4) BETWEEN '1976' AND '1989'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(CMC_TO_MHM), -4) BETWEEN '1976' AND '1989'
...
WHERE INDV_UNIT IS NOT NULL  -- Filter out potential null records
    ...
    AND CAST(SUBSTR(TRIM(APPR_AWD_DATE), -4) AS INTEGER) BETWEEN 1976 AND 1989
;