...
FROM opsanal.main.gors_69_nara g
LEFT JOIN opsanal.main.gors_69_gsvcs gs
ON g.FNATL = gs.code
LEFT JOIN opsanal.main.gors_69_fwops fw
ON g.OPCOD = fw.code
LEFT JOIN opsanal.main.gors_69_provs prov1
ON split_part(CAST(g.PRVC1 AS char),'.',1)  = prov1.code
LEFT JOIN opsanal.main.gors_69_provs prov2
ON split_part(CAST(g.PRVC2 AS char),'.',1)  = prov2.code
LEFT JOIN opsanal.main.gors_69_provs prov3
