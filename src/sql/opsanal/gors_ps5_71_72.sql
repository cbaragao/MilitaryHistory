SELECT 
	remove_nan_decimals(ps5."DATE") AS "DATE"
	,format_date(remove_nan_decimals(ps5."DATE"),6) AS DATE_C
	,ps5.DATAT
...
FROM opsanal.main.gors_ps5_71_72_nara ps5
LEFT JOIN opsanal.main.gors_71_72_gsvcs gs
	ON remove_nan_decimals(ps5.INATL) = gs.code
LEFT JOIN opsanal.main.gors_71_72_fwszs fw
