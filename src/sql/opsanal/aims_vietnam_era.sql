-- AIMS Vietnam Era (1965-1975): Vietnam War Period
...
-- Time period: 1965-1975 (Vietnam War escalation, peak, and withdrawal)
...
SELECT
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(SECBD_MTG), -4) BETWEEN '1965' AND '1975'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(MERIT_START), -4) BETWEEN '1965' AND '1975'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(MERIT_END), -4) BETWEEN '1965' AND '1975'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(ORIG_RECMD_DATE), -4) BETWEEN '1965' AND '1975'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(ENDRSMT_DATE), -4) BETWEEN '1965' AND '1975'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(APPR_AWD_DATE), -4) BETWEEN '1965' AND '1975'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(MAIL_DATE), -4) BETWEEN '1965' AND '1975'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(CMC_TO_MHM), -4) BETWEEN '1965' AND '1975'
...
WHERE INDV_UNIT IS NOT NULL  -- Filter out potential null records
    ...
    AND CAST(SUBSTR(TRIM(APPR_AWD_DATE), -4) AS INTEGER) BETWEEN 1965 AND 1975
;