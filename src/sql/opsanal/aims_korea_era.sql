-- AIMS Korea Era (1946-1964): Post-WWII through Post-Korea
...
-- Time period: 1946-1964 (Post-WWII reconstruction, Korean War, post-Korea buildup)
...
SELECT
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(SECBD_MTG), -4) BETWEEN '1946' AND '1964'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(MERIT_START), -4) BETWEEN '1946' AND '1964'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(MERIT_END), -4) BETWEEN '1946' AND '1964'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(ORIG_RECMD_DATE), -4) BETWEEN '1946' AND '1964'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(ENDRSMT_DATE), -4) BETWEEN '1946' AND '1964'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(APPR_AWD_DATE), -4) BETWEEN '1946' AND '1964'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(MAIL_DATE), -4) BETWEEN '1946' AND '1964'
    ...
    CASE 
        ...
        THEN 
            CASE 
                WHEN SUBSTR(TRIM(CMC_TO_MHM), -4) BETWEEN '1946' AND '1964'
...
WHERE INDV_UNIT IS NOT NULL  -- Filter out potential null records
    ...
    AND CAST(SUBSTR(TRIM(APPR_AWD_DATE), -4) AS INTEGER) BETWEEN 1946 AND 1964
;