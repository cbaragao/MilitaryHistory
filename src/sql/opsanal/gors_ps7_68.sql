...
FROM opsanal.main.gors_ps7_68_nara ps7
LEFT JOIN opsanal.main.gors_68_gsvcs gs1
	ON remove_nan_decimals(ps7.LNAT)  = gs1.code
LEFT JOIN opsanal.main.gors_68_gtyps gt 
	ON remove_nan_decimals(ps7.LTYPE) = gt.code
LEFT JOIN opsanal.main.gors_68_gsvcs gs2
