#!/usr/bin/env python3
"""
AIMS Vietnam Era (1965-1975) Data Processing Script
Processes Vietnam War era military awards data.
...
if __name__ == "__main__":
    ...
    try:
        ...
        processor.log_message("🏁 Vietnam Era partition processing complete")
        if success:
