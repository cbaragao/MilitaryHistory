#!/usr/bin/env python3
"""
AIMS Post-Vietnam (1976-1989) Data Processing Script
Processes Post-Vietnam peacetime period military awards data.
...
if __name__ == "__main__":
    ...
    try:
        ...
        processor.log_message("🏁 Post-Vietnam partition processing complete")
        if success:
