...
Military operational dataset containing INCDA_PS1 related information and records.

## 📊 Dataset Overview

**Data.world Location**: [aragaocb/incda_ps1](https://data.world/aragaocb/incda_ps1)

### Source Information
- **NARA ID**: 2569433
- **Original Filename**: INCDA.AR.PER1
- **Catalog URL**: https://catalog.archives.gov/id/2569433
- **Available Online**: True
- **Source URL**: https://s3.amazonaws.com/NARAprodstorage/opastorage/live/33/5694/2569433/content/arcmedia/electronic-records/rg-218/INCDA/INCDA.AR.PER1

## 🗃️ Data Structure

### Transaction Files
- **incda_ps1_tx.csv**: Primary transaction data file containing 13 fields
...
- **PSSQ1**: System Generated (Type: Alphanumeric, Length: 4)
- **VSZ1**: System Generated (Type: N/A, Length: 4)
- **NODES**: Number destroyed (Type: Numeric, Length: 3)
- **NODAM**: Number damaged (Type: Numeric, Length: 3)
- **NOCAP**: Number captured or missing (Type: Numeric, Length: 3)
...
- **Processing script**: `src/scripts/incda_ps1.py`
...
python src/scripts/incda_ps1.py
```
...
### Data.world Access
- **Public Dataset**: [aragaocb/incda_ps1](https://data.world/aragaocb/incda_ps1)
- **Query Interface**: SQL and SPARQL query support
- **API Access**: REST and GraphQL APIs available

### File Downloads
- **Transaction Data**: `incda_ps1_tx.csv`
- **Schema Metadata**: `incda_ps1_schema.csv`
...
# Connect to dataset
dataset = dw.load_dataset('aragaocb/incda_ps1')

# Access transaction data
df = dataset.dataframes['incda_ps1_tx']
...
```
MilitaryHistory Project. (2025). INCDA_PS1 Dataset. 
Retrieved from https://data.world/aragaocb/incda_ps1
```
