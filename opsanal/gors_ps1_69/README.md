...
Military operational dataset containing GORS_PS1_69 related information and records.

## 📊 Dataset Overview

**Data.world Location**: [aragaocb/gors_ps1_69](https://data.world/aragaocb/gors_ps1_69)

### Source Information
- **NARA ID**: 40978561
- **Original Filename**: GORS69.AR.P1.txt
- **Catalog URL**: https://catalog.archives.gov/id/40978561
- **Available Online**: True
- **Source URL**: https://s3.amazonaws.com/NARAprodstorage/lz/electronic-records/rg-472/GORS/GORS69.AR.PS1.txt

## 🗃️ Data Structure

### Transaction Files
- **gors_ps1_69_tx.csv**: Primary transaction data file containing 14 fields
...
- **Processing script**: `src/scripts/gors_ps1_69.py`
...
python src/scripts/gors_ps1_69.py
```
...
### Data.world Access
- **Public Dataset**: [aragaocb/gors_ps1_69](https://data.world/aragaocb/gors_ps1_69)
- **Query Interface**: SQL and SPARQL query support
- **API Access**: REST and GraphQL APIs available

### File Downloads
- **Transaction Data**: `gors_ps1_69_tx.csv`
- **Schema Metadata**: `gors_ps1_69_schema.csv`
...
# Connect to dataset
dataset = dw.load_dataset('aragaocb/gors_ps1_69')

# Access transaction data
df = dataset.dataframes['gors_ps1_69_tx']
...
```
MilitaryHistory Project. (2025). GORS_PS1_69 Dataset. 
Retrieved from https://data.world/aragaocb/gors_ps1_69
```
