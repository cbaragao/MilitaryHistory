...
Military operational dataset containing GORS_71_72 related information and records.

## 📊 Dataset Overview

**Data.world Location**: [aragaocb/gors_71_72](https://data.world/aragaocb/gors_71_72)

### Source Information
- **NARA ID**: 40978563
- **Original Filename**: GORS7172.AR.FX.txt
- **Catalog URL**: https://catalog.archives.gov/id/40978563
- **Available Online**: True
- **Source URL**: https://s3.amazonaws.com/NARAprodstorage/lz/electronic-records/rg-472/GORS/GORS7172.AR.FX.txt

## 🗃️ Data Structure

### Transaction Files
- **gors_71_72_tx.csv**: Primary transaction data file containing 22 fields
...
- **DATAT**: Basic description of the recorded incident/operation (Type: Alphanumeric, Length: 1)
...
- **SC0**: Subset control group in the key for a specific logical record; created by the NIPSTRAN program (Type: Alphanumeric, Length: 4)
- **VSZ**: Indicates number of characters in the logical record's variable field; the field will contain zeros if there is no variable field for a logical record; created by the NIPSTRAN program (Type: Numeric, Length: 4)
- **OPDAY**: Number of days of operation in one week (Type: Numeric, Length: 4)
- **CTDAY**: Number of days of operation in one week where an enemy was involved (Type: Numeric, Length: 1)
...
- **Processing script**: `src/scripts/gors_71_72.py`
...
python src/scripts/gors_71_72.py
```
...
### Data.world Access
- **Public Dataset**: [aragaocb/gors_71_72](https://data.world/aragaocb/gors_71_72)
- **Query Interface**: SQL and SPARQL query support
- **API Access**: REST and GraphQL APIs available

### File Downloads
- **Transaction Data**: `gors_71_72_tx.csv`
- **Schema Metadata**: `gors_71_72_schema.csv`
...
# Connect to dataset
dataset = dw.load_dataset('aragaocb/gors_71_72')

# Access transaction data
df = dataset.dataframes['gors_71_72_tx']
...
```
MilitaryHistory Project. (2025). GORS_71_72 Dataset. 
Retrieved from https://data.world/aragaocb/gors_71_72
```
