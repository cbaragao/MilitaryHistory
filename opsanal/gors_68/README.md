...
Military operational dataset containing GORS_68 related information and records.

## 📊 Dataset Overview

**Data.world Location**: [aragaocb/gors_68](https://data.world/aragaocb/gors_68)

### Source Information
- **NARA ID**: 40978560
- **Original Filename**: GORS68.AR.FIX.txt
- **Catalog URL**: https://catalog.archives.gov/id/40978560
- **Available Online**: True
- **Source URL**: https://s3.amazonaws.com/NARAprodstorage/lz/electronic-records/rg-472/GORS/GORS68.AR.FIX.txt

## 🗃️ Data Structure

### Transaction Files
- **gors_68_tx.csv**: Primary transaction data file containing 21 fields
...
- **PCN**:  (Type: Alphanumeric, Length: 3)
- **SC0**:  (Type: Alphanumeric, Length: 4)
...
- **OPDAY**: Number of days of operation in one week (Type: Numeric, Length: 3)
- **FNATL**: Force of nationality controlling the action (Type: Alphanumeric, Length: 1)
...
- **Processing script**: `src/scripts/gors_68.py`
...
### Data.world Access
- **Public Dataset**: [aragaocb/gors_68](https://data.world/aragaocb/gors_68)
- **Query Interface**: SQL and SPARQL query support
- **API Access**: REST and GraphQL APIs available

### File Downloads
- **Transaction Data**: `gors_68_tx.csv`
- **Schema Metadata**: `gors_68_schema.csv`
...
# Connect to dataset
dataset = dw.load_dataset('aragaocb/gors_68')

# Access transaction data
df = dataset.dataframes['gors_68_tx']
...
```
MilitaryHistory Project. (2025). GORS_68 Dataset. 
Retrieved from https://data.world/aragaocb/gors_68
```
