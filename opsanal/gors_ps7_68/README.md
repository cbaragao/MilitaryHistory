...
Military operational dataset containing GORS_PS7_68 related information and records.

## 📊 Dataset Overview

**Data.world Location**: [aragaocb/gors_ps7_68](https://data.world/aragaocb/gors_ps7_68)

### Source Information
- **NARA ID**: 40978560
- **Original Filename**: GORS68.AR.PS7.txt
- **Catalog URL**: https://catalog.archives.gov/id/40978560
- **Available Online**: True
- **Source URL**: https://s3.amazonaws.com/NARAprodstorage/lz/electronic-records/rg-472/GORS/GORS68.AR.PS7.txt

## 🗃️ Data Structure

### Transaction Files
- **gors_ps7_68_tx.csv**: Primary transaction data file containing 16 fields
...
- **Processing script**: `src/scripts/gors_ps7_68.py`
...
python src/scripts/gors_ps7_68.py
```
...
### Data.world Access
- **Public Dataset**: [aragaocb/gors_ps7_68](https://data.world/aragaocb/gors_ps7_68)
- **Query Interface**: SQL and SPARQL query support
- **API Access**: REST and GraphQL APIs available

### File Downloads
- **Transaction Data**: `gors_ps7_68_tx.csv`
- **Schema Metadata**: `gors_ps7_68_schema.csv`
...
# Connect to dataset
dataset = dw.load_dataset('aragaocb/gors_ps7_68')

# Access transaction data
df = dataset.dataframes['gors_ps7_68_tx']
...
```
MilitaryHistory Project. (2025). GORS_PS7_68 Dataset. 
Retrieved from https://data.world/aragaocb/gors_ps7_68
```
