# GORS_PS4_71_72 Dataset

Military operational dataset containing GORS_PS4_71_72 related information and records.

## 📊 Dataset Overview

**Data.world Location**: [aragaocb/gors_ps4_71_72](https://data.world/aragaocb/gors_ps4_71_72)

### Source Information
- **NARA ID**: 40978563
- **Original Filename**: GORS7172.AR.P4.txt,
- **Catalog URL**: https://catalog.archives.gov/id/40978563
- **Available Online**: True
- **Source URL**: https://s3.amazonaws.com/NARAprodstorage/lz/electronic-records/rg-472/GORS/GORS7172.AR.P4.txt

## 🗃️ Data Structure

### Transaction Files
- **gors_ps4_71_72_tx.csv**: Primary transaction data file containing 17 fields
...
- **PSSQ4**: Subsequent sequence number used for periodic set identification; created by the NIPSTRAN program (Type: Alphanumeric, Length: 4)
- **VSZ4**: ndicates number of characters in the logical record's variable field; the field will contain zeros if there is no variable field for a logical record; created by the NIPSTRAN program (Type: Numeric, Length: 4)
- **NODES**: Number personnel KIA (killed in action), amount material destroyed or number of rounds of ammunition expended for appropriates codes in table CATRS (Type: Numeric, Length: 5)
- **NODAM**: The number of friendly personnel WIA (wounded in action), enemy returnees (RET), or material damaged (Type: Numeric, Length: 5)

... and 7 more fields. See schema documentation for complete field definitions.
...
- **Processing script**: `src/scripts/gors_ps4_71_72.py`
...
python src/scripts/gors_ps4_71_72.py
```
...
### Data.world Access
- **Public Dataset**: [aragaocb/gors_ps4_71_72](https://data.world/aragaocb/gors_ps4_71_72)
- **Query Interface**: SQL and SPARQL query support
- **API Access**: REST and GraphQL APIs available

### File Downloads
- **Transaction Data**: `gors_ps4_71_72_tx.csv`
- **Schema Metadata**: `gors_ps4_71_72_schema.csv`
...
# Connect to dataset
dataset = dw.load_dataset('aragaocb/gors_ps4_71_72')

# Access transaction data
df = dataset.dataframes['gors_ps4_71_72_tx']
...
```
MilitaryHistory Project. (2025). GORS_PS4_71_72 Dataset. 
Retrieved from https://data.world/aragaocb/gors_ps4_71_72
```
