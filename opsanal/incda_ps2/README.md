...
Military operational dataset containing INCDA_PS2 related information and records.

## 📊 Dataset Overview

**Data.world Location**: [aragaocb/incda_ps2](https://data.world/aragaocb/incda_ps2)

### Source Information
- **NARA ID**: 2569435
- **Original Filename**: INCDA.AR.PER2
- **Catalog URL**: https://catalog.archives.gov/id/2569435
- **Available Online**: True
- **Source URL**: https://s3.amazonaws.com/NARAprodstorage/opastorage/live/35/5694/2569435/content/arcmedia/electronic-records/rg-218/INCDA/INCDA.AR.PER2

## 🗃️ Data Structure

### Transaction Files
- **incda_ps2_tx.csv**: Primary transaction data file containing 11 fields
...
- **PSSQ2**: System Generated (Type: Alphanumeric, Length: 4)
- **VSZ2**: System Generated (Type: Numeric, Length: 4)
- **QTYRCD**: Number of rounds received (Type: Numeric, Length: 3)
- **FORID**: Identification of the friendly force involved in the incident (Type: Alphanumeric, Length: 20)
- **SUPID**: Identification of the friendly supporting force, if any (Type: Alphanumeric, Length: 20)

... and 1 more fields. See schema documentation for complete field definitions.
...
- **Processing script**: `src/scripts/incda_ps2.py`
...
python src/scripts/incda_ps2.py
```
...
### Data.world Access
- **Public Dataset**: [aragaocb/incda_ps2](https://data.world/aragaocb/incda_ps2)
- **Query Interface**: SQL and SPARQL query support
- **API Access**: REST and GraphQL APIs available

### File Downloads
- **Transaction Data**: `incda_ps2_tx.csv`
- **Schema Metadata**: `incda_ps2_schema.csv`
...
# Connect to dataset
dataset = dw.load_dataset('aragaocb/incda_ps2')

# Access transaction data
df = dataset.dataframes['incda_ps2_tx']
...
```
MilitaryHistory Project. (2025). INCDA_PS2 Dataset. 
Retrieved from https://data.world/aragaocb/incda_ps2
```
