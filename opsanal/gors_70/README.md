...
Military operational dataset containing GORS_70 related information and records.

## 📊 Dataset Overview

**Data.world Location**: [aragaocb/gors_70](https://data.world/aragaocb/gors_70)

### Source Information
- **NARA ID**: 40978562
- **Original Filename**: GORS70.AR.FX.txt
- **Catalog URL**: https://catalog.archives.gov/id/40978562
- **Available Online**: True
- **Source URL**: https://s3.amazonaws.com/NARAprodstorage/lz/electronic-records/rg-472/GORS/GORS70.AR.FIX.txt

## 🗃️ Data Structure

### Transaction Files
- **gors_70_tx.csv**: Primary transaction data file containing 21 fields
...
- **Processing script**: `src/scripts/gors_70.py`
...
### Data.world Access
- **Public Dataset**: [aragaocb/gors_70](https://data.world/aragaocb/gors_70)
- **Query Interface**: SQL and SPARQL query support
- **API Access**: REST and GraphQL APIs available

### File Downloads
- **Transaction Data**: `gors_70_tx.csv`
- **Schema Metadata**: `gors_70_schema.csv`
...
# Connect to dataset
dataset = dw.load_dataset('aragaocb/gors_70')

# Access transaction data
df = dataset.dataframes['gors_70_tx']
...
```
MilitaryHistory Project. (2025). GORS_70 Dataset. 
Retrieved from https://data.world/aragaocb/gors_70
```
