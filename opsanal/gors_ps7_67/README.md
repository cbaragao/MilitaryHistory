...
Military operational dataset containing GORS_PS7_67 related information and records.

## 📊 Dataset Overview

**Data.world Location**: [aragaocb/gors_ps7_67](https://data.world/aragaocb/gors_ps7_67)

### Source Information
- **NARA ID**: 40978559
- **Original Filename**: GORS67.AR.PS7.txt
- **Catalog URL**: https://catalog.archives.gov/id/40978559
- **Available Online**: True
- **Source URL**: https://s3.amazonaws.com/NARAprodstorage/lz/electronic-records/rg-472/GORS/GORS67.AR.PS7.txt

## 🗃️ Data Structure

### Transaction Files
- **gors_ps7_67_tx.csv**: Primary transaction data file containing 16 fields
...
- **Processing script**: `src/scripts/gors_ps7_67.py`
...
python src/scripts/gors_ps7_67.py
```
...
### Data.world Access
- **Public Dataset**: [aragaocb/gors_ps7_67](https://data.world/aragaocb/gors_ps7_67)
- **Query Interface**: SQL and SPARQL query support
- **API Access**: REST and GraphQL APIs available

### File Downloads
- **Transaction Data**: `gors_ps7_67_tx.csv`
- **Schema Metadata**: `gors_ps7_67_schema.csv`
...
# Connect to dataset
dataset = dw.load_dataset('aragaocb/gors_ps7_67')

# Access transaction data
df = dataset.dataframes['gors_ps7_67_tx']
...
```
MilitaryHistory Project. (2025). GORS_PS7_67 Dataset. 
Retrieved from https://data.world/aragaocb/gors_ps7_67
```
